...
import static com.spring2020.coffeeshop.util.ConstantUtil.PHONE_REX;
...
public class StaffAppUserDto {
    ...
    @NotNull(message = "{userApp.password.notNull}")
    @Length(min = 3, max = 100, message = "{userApp.password.length}")
